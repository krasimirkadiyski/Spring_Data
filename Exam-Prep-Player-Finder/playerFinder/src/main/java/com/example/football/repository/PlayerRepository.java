...
public interface PlayerRepository extends JpaRepository<Player,Long> {
    ...
    @Query("SELECT new com.example.football.models.dto.ExportPlayerDto(p.firstName,p.lastName,p.position,p.team.name,p.team.stadiumName) FROM Player as p JOIN p.stat as s WHERE p.birthDate" +
